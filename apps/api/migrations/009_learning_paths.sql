...
CREATE INDEX IF NOT EXISTS learning_paths_catalog_idx ON learning_paths(published, created_at DESC);
CREATE INDEX IF NOT EXISTS learning_path_progress_user_idx ON learning_path_progress(user_id, updated_at DESC);
